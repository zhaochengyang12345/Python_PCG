...
OUTPUT_DIR  = SCRIPT_DIR / "Result" / "MobileNet"
IMG_SIZE    = (128, 128)
BATCH_SIZE  = 8
OUT_C = 1024   # GlobalAveragePooling 后的特征维数
...
if __name__ == '__main__':
    ...
    print(f"共找到 {len(img_paths)} 张图片，使用 MobileNet 提取特征...")
    ...
    out_path = OUTPUT_DIR / "mobilenet_features.xlsx"
