...
OUTPUT_DIR  = SCRIPT_DIR / "Result" / "VGG16"
IMG_SIZE    = (128, 128)
BATCH_SIZE  = 8
OUT_C = 512   # GlobalAveragePooling 后的特征维数
...
if __name__ == '__main__':
    ...
    print(f"共找到 {len(img_paths)} 张图片，使用 VGG16 提取特征...")
    ...
    out_path = OUTPUT_DIR / "vgg16_features.xlsx"
